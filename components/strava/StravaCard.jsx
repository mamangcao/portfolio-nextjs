...
import { SneakerMoveIcon, BarbellIcon, SneakerIcon, PulseIcon } from "@phosphor-icons/react";
    ...
    <Card title="Physical Activities">
      <div className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button className="flex flex-col items-center justify-center gap-1 p-2 bg-zinc-100 dark:bg-zinc-800 rounded-md hover:bg-zinc-200 dark:hover:bg-zinc-700 hover:scale-105 transition-colors text-zinc-600 dark:text-zinc-300">
          ...
          <button className="flex flex-col items-center justify-center gap-1 p-2 bg-zinc-100 dark:bg-zinc-800 rounded-md hover:bg-zinc-200 dark:hover:bg-zinc-700 hover:scale-105 transition-colors text-zinc-600 dark:text-zinc-300">
            <BarbellIcon size={24} weight="duotone" />
