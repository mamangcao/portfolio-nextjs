      ...
      <a href="https://medium.com/@ideya.cit/ideyahack-launched-2nd-edition-focused-on-health-60ffa4823ad8">
        <ul className="group space-y-1">
          ...
          <li className="text-xs text-gray-700 dark:text-gray-100">
            ...
            <span className="text-xs font-mono text-gray-800 dark:text-white border border-gray-300 dark:border-gray-400 bg-white dark:bg-midnight-100 px-2 py-1 rounded-full group-hover:bg-midnight-50 group-hover:text-white dark:group-hover:bg-white dark:group-hover:text-black">
              UpBank
            </span>
          </li>
        </ul>
